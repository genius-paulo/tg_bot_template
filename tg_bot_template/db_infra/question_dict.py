question_dict = {'question1':
                 ...
                 {'question': 'Что делает функция enumerate()?',
                  ...
                  'question3':
                 {'question': 'Какой метод вызывается при использовании оператора in для проверки наличия элемента в пользовательском классе?',
                  'answer1': '__contains__',
                  'answer2': '__hasitem__',
                  'answer3': '__getitem__',
                  'right_answer': '__contains__'},
                  'question4':
                 {'question': 'Какой оператор позволяет «перепрыгнуть» оставшиеся выражения в цикле и перейти к следующей итерации?',
                  'answer1': 'pass',
                  'answer2': 'else',
                  'answer3': 'continue',
                 ...
                 {'question': 'Какой модуль Python поддерживает регулярные выражения?',
                  ...
                  'right_answer': 're'},
                  'question6':
                 {'question': 'Чем можно заменить комментарий в теле функции, чтобы использовать минимум кода и избежать ошибок?',
                 ...
                 {'question': 'Что из перечисленного ниже является недопустимым именем переменной в Python?',
                  ...
                  'right_answer': 'yield'},
                  'question12':
                 {'question': 'Какое исключение будет выброшено, если попытаться изменить кортеж после его создания?',
                  'answer1': 'ValueError',
                  'answer2': 'TypeError',
